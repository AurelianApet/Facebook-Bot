    ...
    public class ManagerController : Controller
    {
        ...
        public ActionResult Index(string email)
        {
            try 
            {
                ...
                var admin = db.tbl_userlist.Where(a => a.email == email).FirstOrDefault();
                string url = "https://graph.facebook.com/" + admin.page_id +"/leadgen_forms?access_token=" + admin.token;
